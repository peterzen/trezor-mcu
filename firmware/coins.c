...
const CoinType coins[COINS_COUNT] = {
	...
	{true, "Decred",        true, " DCR",  true, 1855, true,  100000000, true, 1818, true, "\x17" "Decred Signed Message:\n",   true, 0x02fda926, true, 0x02fda4e8, true, false, },
	{true, "DecredTestnet", true, " DCRT", true, 3873, true,  100000000, true, 3836, true, "\x17" "Decred Signed Message:\n",   true, 0x043587d1, true, 0x04358397, true, false, },
};
