...
const pb_field_t DecredLoadDevice_fields[8] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, STATIC  , FIRST, DecredLoadDevice, mnemonic, mnemonic, 0),
    PB_FIELD2(  2, MESSAGE , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, node, mnemonic, &HDNodeType_fields),
    PB_FIELD2(  3, STRING  , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, pin, node, 0),
    PB_FIELD2(  4, BOOL    , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, passphrase_protection, pin, 0),
    PB_FIELD2(  5, STRING  , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, language, passphrase_protection, &DecredLoadDevice_language_default),
    PB_FIELD2(  6, STRING  , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, label, language, 0),
    PB_FIELD2(  7, UINT32  , OPTIONAL, STATIC  , OTHER, DecredLoadDevice, u2f_counter, label, 0),
    PB_LAST_FIELD
};

const pb_field_t DecredGetAddress_fields[3] = {
    PB_FIELD2(  1, UINT32  , REPEATED, STATIC  , FIRST, DecredGetAddress, address_n, address_n, 0),
    PB_FIELD2(  2, BOOL    , OPTIONAL, STATIC  , OTHER, DecredGetAddress, show_display, address_n, 0),
    PB_LAST_FIELD
};

const pb_field_t DecredAddress_fields[2] = {
    PB_FIELD2(  1, STRING  , REQUIRED, STATIC  , FIRST, DecredAddress, address, address, 0),
    PB_LAST_FIELD
};
...
const pb_field_t DecredTxRequest_fields[4] = {
    PB_FIELD2(  1, ENUM    , OPTIONAL, STATIC  , FIRST, DecredTxRequest, request_type, request_type, 0),
    PB_FIELD2(  2, MESSAGE , OPTIONAL, STATIC  , OTHER, DecredTxRequest, details, request_type, &TxRequestDetailsType_fields),
    PB_FIELD2(  3, MESSAGE , OPTIONAL, STATIC  , OTHER, DecredTxRequest, serialized, details, &TxRequestSerializedType_fields),
    PB_LAST_FIELD
};

const pb_field_t DecredTxAck_fields[2] = {
    PB_FIELD2(  1, MESSAGE , OPTIONAL, STATIC  , FIRST, DecredTxAck, tx, tx, &DecredTransactionType_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(DecredLoadDevice, node) < 65536 && pb_membersize(DecredTxRequest, details) < 65536 && pb_membersize(DecredTxRequest, serialized) < 65536 && pb_membersize(DecredTxAck, tx) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(GetECDHSessionKey, identity) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_EthereumGetAddress_Address_EthereumAddress_WipeDevice_LoadDevice_DecredLoadDevice_DecredGetAddress_DecredAddress_DecredEntropyAck_DecredSignMessage_DecredVerifyMessage_DecredSignTx_DecredTxRequest_DecredTxAck_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_TxRequest_TxAck_EthereumSignTx_EthereumTxRequest_EthereumTxAck_SignIdentity_SignedIdentity_GetECDHSessionKey_ECDHSessionKey_SetU2FCounter_FirmwareErase_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkMemoryRead_DebugLinkMemory_DebugLinkMemoryWrite_DebugLinkFlashErase)
#endif
