...
void fsm_msgGetPublicKey(GetPublicKey *msg)
{
	...
	// modified hdnode_serialize_public() that takes a version argument
	hdnode_serialize_public_version(node, fingerprint, coin->xpub_magic, resp->xpub, sizeof(resp->xpub));
